...
public class ConfigurationReader 
{
        ...
        public ConfigurationReader() throws Exception
        {
                ...
                File configFile = new File(this.getClass().getResource("/META-INF/" + CONFIG_FILE_NAME).toURI());
                if(!configFile.exists())
                        throw new RuntimeException("Unable to find " + CONFIG_FILE_NAME + " file.");
                
                File versionFile = new File(this.getClass().getResource("/META-INF/" + VERSION_FILE_NAME).toURI());
                ...
                {
                        XMLConfiguration configuration = new XMLConfiguration(new File(this.getClass().getResource("/META-INF/persistence.xml").toURI()));
